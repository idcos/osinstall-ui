...
export default Ember.Service.extend({
    ...
    */
    create : function(form) {
        var url = "/api/osinstall/v1/network/add";
		//生成发请求数据对象
		var data = {};
		data = form;
    ...
    */
    get : function(id) {
        var url = "/api/osinstall/v1/network/view";
		//生成发请求数据对象
		var data = {};
		data.ID = parseInt(id);
    ...
    */
    validateIp : function(ip) {
        var url = "/api/osinstall/v1/network/validateIp";
		//生成发请求数据对象
		var data = {};
		data.Ip = ip
    ...
    */
    deleteRowById : function(id) {
        var url = "/api/osinstall/v1/network/delete";
		//生成发请求数据对象
		var data = {};
		data.ID = parseInt(id);
    ...
    */
    update : function(form) {
        var url = "/api/osinstall/v1/network/update";
		//生成发请求数据对象
		var data = {};
		data = form;
    ...
    */
    list : function(limit,offset) {
        var url = "/api/osinstall/v1/network/list";
		//生成发请求数据对象
		var data = {};
		data.Limit = limit;
		data.Offset = offset;
